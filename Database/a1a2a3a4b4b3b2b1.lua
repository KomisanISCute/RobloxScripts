local v23q = game:GetService("RbxAnalyticsService"):GetClientId()
local v21 = loadstring(game:HttpGet('https://raw.githubusercontent.com/KomisanISCute/RobloxScripts/main/Database/KeyStorage.lua'))()
print(v21)
local a12b = 'LUNARISCOMEBBACK'
if (_G.key == v21) or (a12b==v23q) then
	print('[Passed Code : 691]')
...
_G.Settings = {
	...
	Main = {
		...
		["Select Lock Buy Sword"] = 'Wando', --Saddi / Shisui
...
function LoadSettings()
	if readfile and writefile and isfile and isfolder then
		if not isfolder("LUNAR HUB") then
			makefolder("LUNAR HUB")
		end
		if not isfolder("LUNAR HUB/Blox Fruits/") then
			makefolder("LUNAR HUB/Blox Fruits/")
		end
		if not isfile("LUNAR HUB/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
			writefile("LUNAR HUB/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(_G.Settings))
		else
			local Decode = game:GetService("HttpService"):JSONDecode(readfile("LUNAR HUB/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json"))
...
function SaveSettings()
	if readfile and writefile and isfile and isfolder then
		if not isfile("LUNAR HUB/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
			...
			writefile("LUNAR HUB/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(Array))
		end
	else
		return warn("Status : Undetected Executor")
	end
...
local function toTarget(...)
	...
	if _G.Settings.Configs["Instant TP"] == true then
...
spawn(function()
	while wait() do
		if G.Settings.Main["Auto Farm Level"] then
			pcall(function()
				if _G.Settings.Main["Auto Farm Level"] then
...
local i = Library:create({Name = "LUNAR HUB"})
local tab = i:createtab({Name = "[ Normal ]"})

local General = tab:createsection({Name = "General"})
local Tab1 = General:createpage()

local PS = tab:createsection({Name = "Player/Stats"})
local Tab2 = PS:createpage()

local TR = tab:createsection({Name = "Teleport/Raid"})
local Tab3 = TR:createpage()

local MK = tab:createsection({Name = "Makets"})
local Tab4 = MK:createpage()

local MI = tab:createsection({Name = "Miscs"})
local Tab5 = MI:createpage()

local sE = tab:createsection({Name = "Settings"})
local Tab6 = sE:createpage()
Tab6:Toggle({
	Title = "White Screen",
	Default = _G.Settings.HUD["White Screen"],
	callback = function(z)
	_G.Settings.HUD["White Screen"] = z
	SaveSettings()
...
Tab6:Toggle({
	Title = "Allowed All Hop\n[ Enable For Auto Hop on All function ]",
	Default = _G.Settings.Configs["Enabled Hop"],
	callback = function(z)
	_G.Settings.Configs["Enabled Hop"] = z
	SaveSettings()
end})

function A()
    while task.wait() do
		if _G.Settings.Configs["Enabled Hop"] == true then
			pcall(function()
				TPReturner()
				if foundAnything ~= "" then
					TPReturner()
...
local c1 = tab:createsection({Name = "Credits"})
local c = c1:createpage()
...
c:Label({
    Title = 'Scripts Developed By #Lonely4631',
})
c:Button({
    Title = 'Copy Discord Link',
    callback = function()
        setclipboard('https://discord.gg/fFPPfBVPmk')
end})
...
function AutoFarmLevel()
	if _G.Settings.Main["Fast Auto Farm Level"] == true then
	...
	if (_G.Settings.Main["Fast Auto Farm Level"] == true) and (MyLevel >= 33 and MyLevel <= 300) then
		if _G.Settings.Configs["Auto Haki"] then
			if not game.Players.LocalPlayer.Character:FindFirstChild("HasBuso") then
				game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Buso")
			end
		end
		if MyLevel >= 33 and MyLevel <= 75 then
			...
			if game:GetService("Workspace").Enemies:FindFirstChild("God's Guard [Lv. 450]") then
				for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
					if (_G.Settings.Main["Fast Auto Farm Level"] == true) and v.Name == "God's Guard [Lv. 450]" and v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 then
						repeat task.wait()
							...
							if v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and (v.HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).magnitude <= 300 then
								...
								for i2,v2 in pairs(game:GetService("Workspace").Enemies:GetChildren()) do 
									if (_G.Settings.Main["Fast Auto Farm Level"] == true) and v2.Name == "God's Guard [Lv. 450]" and v2:FindFirstChild("HumanoidRootPart") and v2:FindFirstChild("Humanoid") and v2.Humanoid.Health > 0 then
				...
				if Sea1 and (CFrame.new(-4698, 845, -1912).Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).magnitude >1500 then
		...
		elseif MyLevel >= 75 and MyLevel <= 300 then
			if GetQuest.Visible == false then
				if not tostring(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("PlayerHunter")):find("We heard some") then 
					...
					if game:GetService("Workspace").Enemies:FindFirstChild("God's Guard [Lv. 450]") then
						...
						toTarget(CFrame.new(-4698, 845, -1912))
						Modstween = toTarget(CFrame.new(-4698, 845, -1912))
						if Sea1 and (CFrame.new(-4698, 845, -1912).Position - game:GetService("Players").LocalPlayer.Character:WaitForChild("HumanoidRootPart").Position).magnitude > 1500 then
							if Modstween then Modstween:Stop() end
							game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(-4607.8227539063, 872.54248046875, -1667.5568847656))
						elseif (CFrameMon.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).magnitude <= 150 then
							if Modstween then Modstween:Stop() end
				...
				if table.find(AllPlayersTableSkipFarm,GetQuestTitle.Text:split(" ")[2]) then
					for i,v in pairs(game:GetService("Workspace").Characters:GetChildren()) do
						if string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text,v.Name) then
							if _G.Settings.Main["Auto Farm Level"] and (_G.Settings.Main["Fast Auto Farm Level"] == true) and v.Name == GetQuestTitle.Text:split(" ")[2] and v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 then
								repeat task.wait()
									...
									elseif v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and (v.HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).magnitude <= 150 then
										...
										elseif AttackRandomType == 2 then
											game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = v.HumanoidRootPart.CFrame * CFrame.new(0, 1, 20)
										elseif AttackRandomType == 3 then
											game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = v.HumanoidRootPart.CFrame * CFrame.new(1, 1, -20)
										elseif AttackRandomType == 4 then
											game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = v.HumanoidRootPart.CFrame * CFrame.new(20, 1, 0)
										elseif AttackRandomType == 5 then
											game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = v.HumanoidRootPart.CFrame * CFrame.new(-20, 1, 0)
										else
											game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = v.HumanoidRootPart.CFrame * CFrame.new(0, 20, 1)
				...
				for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
					if _G.Settings.Main["Auto Farm Level"] and v.Name == Name and v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 then
						if string.find(GetQuestTitle.Text, NameMon) then
							repeat task.wait()
								FarmtoTarget = toTarget(v.HumanoidRootPart.CFrame * CFrame.new(0,_G.Settings.Configs["Distance Form Position"],0))
								if v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and (v.HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).magnitude <= 250 then
									...
									StartMagnet = true
									FastAttack = true
									if game.Players.LocalPlayer.Data.Level.Value >= 30 and game.Players.LocalPlayer.Data.Level.Value <= 65 then
									...
									game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = v.HumanoidRootPart.CFrame * CFrame.new(0,_G.Settings.Configs["Distance Form Position"],0)
								end
...
function CheckNotifyComplete()
	for i, v in pairs(game:GetService("Players")["LocalPlayer"].PlayerGui:FindFirstChild("Notifications"):GetChildren()) do
		if v.Name == "NotificationTemplate" then
			if string.upper(v.Text):find("quest completed") then
				pcall(function()
					v:Destroy()
				end)
				return true
...
Tab1:Toggle({
	Title = "Auto Farm Nearest (In Distance)",
...
if Sea1 then
	...
	local God = Tab1:Label({
		Title = "0/4"
	})

	Tab1:Label({Title= "Farm Materail"})

	Tab1:Dropdown({Title = "Select Material",Item = AllMaterial,callback = function(value)
					...
					xpcall(function()
						if (SelectModeMaterial~="") then 
							...
							if CustomFindFirstChild(MaterialMob) then
								...
								FastAttack=false;
								Modstween = toTarget(CFrameMon);
								if (Sea1 and (table.find(MaterialMob,"Fishman Commando [Lv. 400]")) and ((CFrameMon.Position-game:GetService("Players").LocalPlayer.Character:WaitForChild("HumanoidRootPart").Position).magnitude>50000)) then 
								...
								elseif (Sea1 and not (table.find(MaterialMob,"Fishman Commando [Lv. 400]")) and ((CFrameMon.Position-game:GetService("Players").LocalPlayer.Character:WaitForChild("HumanoidRootPart").Position).magnitude>50000)) then 
								...
								elseif (Sea1 and (table.find(MaterialMob,"God's Guard [Lv. 450]")) and ((CFrameMon.Position-game:GetService("Players").LocalPlayer.Character:WaitForChild("HumanoidRootPart").Position).magnitude>3000)) then 
...
elseif Sea2 then
	...
	Tab1:Label({Title= "Auto Farm Materials"})
...
elseif Sea3 then
	...
	Tushita_Quest1 = nil
	-- Tab1:Button({Title = "Tushita Quest : 1",callback = function()
	-- 	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("LoadItem","Tushita")
	-- 	wait(1)
	-- 	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CDKQuest","StartTrial","Good")
	-- 	Tushita_Quest1 = true
	...
	if Tushita_Quest1 == false then
		...
		Tab1:Label{Title = "Walk up to the Halloween boss and kill afterward, light your torch and turn on the Auto Mob Aura."}
	end
end
...
Tab6:Toggle({
	Title = "Instant TP",
	Default = _G.Settings.Configs["Instant TP"],
	callback = function(value)
		_G.Settings.Configs["Instant TP"] = value
		SaveSettings()
	end,
})
...
local function a(b)
	...
	for i=1,#Enemies do local v = Enemies[i]
		local Human = v:FindFirstChildOfClass("Humanoid")
		if Human and Human.RootPart and Human.Health > 0 and Client:DistanceFromCharacter(Human.RootPart.Position) < b then
			table.insert(Hits,Human.RootPart)
		end
	end
	return Hits
end
local function DamageAura()
	local ac = CombatFrameworkR.activeController
	if ac and ac.equipped then
		for inc = 1, 1 do
			local bladehit = a(200)
			if #bladehit > 0 then
				local AcAttack8 = debug.getupvalue(ac.attack, 5)
				local AcAttack9 = debug.getupvalue(ac.attack, 6)
				local AcAttack7 = debug.getupvalue(ac.attack, 4)
...
Tab6:Toggle({
	Title = "Damage Aura",
	Default = _G.Settings.Configs["Damage Aura"],
	callback = function(value)
		_G.Settings.Configs["Damage Aura"] = value
		SaveSettings()
        task.spawn(function()
            while task.wait() do
                if _G.Settings.Config["Damage Aura"] or value == true then
					DamageAura()
				end
			end
        end)
...
local FastAttackType={"Fast","Normal","Slow"}if _G.Settings.Configs["Fast Attack Type"]==""then _G.Settings.Configs["Fast Attack Type"]="Fast"end
Tab6:Dropdown({
...
Tab6:Slider({
	Title = "Distance Form Position",
	Min = 0,
	Default = _G.Settings.Configs["Distance Form Position"],
	Max = 60,
	callback = function(value)
		_G.Settings.Configs["Distance Form Position"] = value
		SaveSettings()
	end,
})
...
task.spawn(function()
	while wait() do
		pcall(function()
			if _G.Settings.FightingStyle["Auto God Human"] and Sea2 then
...
Tab1:Toggle({
	Title = "Auto Fully Electric Claw",
						...
						if game.Players.LocalPlayer:FindFirstChild("WeaponAssetCache") then
							...
							if game.Players.LocalPlayer.Character:FindFirstChild("Electro") and game.Players.LocalPlayer.Character:FindFirstChild("Electro").Level.Value >= 400 then
								...
								if v175 == 4 then
									...
									local s21 = game:GetService('Players').LocalPlayer.Data.Fragments.Value
									if s21 <= 4999 then
										--Auto Raid
									else
...
Tab1:Toggle({
	Title = "Auto Fully SharkmanKarate",
...
function AutoFarmMasteryGun()
	if game:GetService("Workspace").Enemies:FindFirstChild(Name) then
		...
		elseif Sea1 and not (Name == "Fishman Commando [Lv. 400]" or Name == "Fishman Warrior [Lv. 375]") and (CFrameQuest.Position - game:GetService("Players").LocalPlayer.Character:WaitForChild("HumanoidRootPart").Position).magnitude > 50000 then
			if Modstween then Modstween:Stop() end wait(.5)
			game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(3864.8515625, 6.6796875, -1926.7841796875))
		elseif Sea1 and (Name == "God's Guard [Lv. 450]" or Name == "Sky Bandit [Lv. 150]" or Name == "Dark Master [Lv. 175]") and (CFrameQuest.Position - game:GetService("Players").LocalPlayer.Character:WaitForChild("HumanoidRootPart").Position).magnitude > 3000 then
			if Modstween then Modstween:Stop() end wait(.5)
			game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance", Vector3.new(-4607.8227539063, 872.54248046875, -1667.5568847656))
		elseif Sea1 and (Name == "Shanda [Lv. 475]" or Name == "Royal Squad [Lv. 525]"or Name == "Royal Soldier [Lv. 550]") and (CFrameQuest.Position - game:GetService("Players").LocalPlayer.Character:WaitForChild("HumanoidRootPart").Position).magnitude > 5000 then
			if Modstween then Modstween:Stop() end wait(.5)
...
local SwordMulti = Tab1:Dropdown({
	Title = "Select Sword",
...
Tab1:Button({Title = "Refresh",callback = function()
	SwordMulti:Clear();
	local AllSwordInInventroy = {};
	for i, v in pairs(game:GetService("ReplicatedStorage").Remotes['CommF_']:InvokeServer("getInventoryWeapons")) do
		if (type(v) == "table") then
...
function AutoFarmMasterySwordList()
	if game:GetService("Workspace").Enemies:FindFirstChild(Name) or (ThreeWorld and (game:GetService("Workspace").Enemies:FindFirstChild("Reborn Skeleton [Lv. 1975]") or game:GetService("Workspace").Enemies:FindFirstChild("Living Zombie [Lv. 2000]") or game:GetService("Workspace").Enemies:FindFirstChild("Demonic Soul [Lv. 2025]") or game:GetService("Workspace").Enemies:FindFirstChild("Posessed Mummy [Lv. 2050]"))) then
		...
		StartMagnet = false
		Modstween = toTarget(CFrameMon)
		if Sea1 and (Name == "Fishman Commando [Lv. 400]" or Name == "Fishman Warrior [Lv. 375]") and (CFrameMon.Position - game:GetService("Players").LocalPlayer.Character:WaitForChild("HumanoidRootPart").Position).magnitude > 50000 then
			if Modstween then Modstween:Stop() end wait(.5)
			game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(61163.8515625, 11.6796875, 1819.7841796875))
		elseif Sea1 and not (Name == "Fishman Commando [Lv. 400]" or Name == "Fishman Warrior [Lv. 375]") and (CFrameMon.Position - game:GetService("Players").LocalPlayer.Character:WaitForChild("HumanoidRootPart").Position).magnitude > 50000 then
			if Modstween then Modstween:Stop() end wait(.5)
			game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(3864.8515625, 6.6796875, -1926.7841796875))
		elseif Sea1 and (Name == "God's Guard [Lv. 450]" or Name == "Sky Bandit [Lv. 150]" or Name == "Dark Master [Lv. 175]") and (CFrameMon.Position - game:GetService("Players").LocalPlayer.Character:WaitForChild("HumanoidRootPart").Position).magnitude > 3000 then
			if Modstween then Modstween:Stop() end wait(.5)
			game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance", Vector3.new(-4607.8227539063, 872.54248046875, -1667.5568847656))
		elseif Sea1 and (Name == "Shanda [Lv. 475]" or Name == "Royal Squad [Lv. 525]"or Name == "Royal Soldier [Lv. 550]") and (CFrameMon.Position - game:GetService("Players").LocalPlayer.Character:WaitForChild("HumanoidRootPart").Position).magnitude > 5000 then
			if Modstween then Modstween:Stop() end wait(.5)
			game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance", Vector3.new(-7894.6176757813, 5547.1416015625, -380.29119873047))
		elseif Sea2 and string.find(Name, "Ship") and (CFrameMon.Position - game:GetService("Players").LocalPlayer.Character:WaitForChild("HumanoidRootPart").Position).magnitude > 30000 then
			if Modstween then Modstween:Stop() end
			game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(923.21252441406, 126.9760055542, 32852.83203125))
		elseif Sea2 and not string.find(Name, "Ship") and (CFrameMon.Position - game:GetService("Players").LocalPlayer.Character:WaitForChild("HumanoidRootPart").Position).magnitude > 30000 then
			if Modstween then Modstween:Stop() end
			game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(-6508.5581054688, 89.034996032715, -132.83953857422))
...
Tab1:Toggle({Title = "Auto Farm Sword Mastery",Default = _G.Settings.Mastery["Farm Mastery SwordList"],callback = function(x)
...
local getplayers={}
for idx,val in pairs(game:GetService('Players'):GetChildren()) do
    table.insert(getplayers,val)
end
local PlayerDrop = Tab2:Dropdown({
	Title = "Select Player",
	Item = getplayers,
	callback = function(value)
		SelectPlayer = value
...
spawn(function()
	while wait() do
		if teleporttop then
			...
			pcall(function()
				repeat task.wait()
					toTarget(game.Players[SelectPlayer].Character.HumanoidRootPart.CFrame*CFrame.new(0,-5,5))
					game.Players[SelectPlayer].Character.HumanoidRootPart.Size = Vector3.new(55,55,55)
				...
				until teleporttop==false or game.Players[SelectPlayer].Character.Health < 0
			end)
		end
	end
end)
...
if _G.Settings.Raids["Select Raids"] == '' then _G.Settings.Raids["Select Raids"] = 'Flame' end
...
Tab4:Label({Title = "Bones"})
spawn(function()
	while wait() do
		if RandomFut or _G.Settings.Main["Auto Farm Level"] then
			local args = {
				[1] = "Cousin",
				[2] = "Buy"
			}
...
if Sea2 then
	Tab4:Label({Title = "Legendary Sword"})
local LGS = Tab4:Dropdown({
		Title = "Select Lock Swords",
		Item = {'Wando','Saddi','Shisui'},
		Default = _G.Settings.Main["Select Lock Buy Swords"],
		callback = function(v)
			_G.Settings.Main["Select Lock Buy Swords"] = v
			SaveSettings()
		end,
	})
	Tab4:Toggle({
		Title = "Auto Buy Lock Sword",
		Default = _G.Settings.Main["Auto Buy Lock Sword"],
		callback = function(value)
			_G.Settings.Main["Auto Buy Lock Sword"] = value
			SaveSettings()
		end,
	})
end
...
spawn(function()
	while task.wait() do
		if _G.Settings.Main["Auto Buy Lock Sword"] then
			if _G.Settings.Main["Select Lock Buy Sword"] == 'Wando' then
				local args = {
			...
			if _G.Settings.Main["Select Lock Buy Sword"] == 'Saddi' then
				local args = {
					[1] = "LegendarySwordDealer",
					[2] = "2"
				}
			...
			if _G.Settings.Main["Select Lock Buy Sword"] == 'Shisui' then
				local args = {
					[1] = "LegendarySwordDealer",
					[2] = "3"
				}
...
Tab4:Label({Title = "Fragment"})

Tab4:Button({Title = "Refund Stat", callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Refund","1")
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Refund","2")
end})

Tab4:Button({Title = "Reroll Race", callback = function()
...
Tab4:Label({Title = "Buy Abilities"})

Tab4:Button({Title = "Haki", callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki","Buso")
end})
Tab4:Button({Title = "Geppo", callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki","Geppo")
end})
Tab4:Button({Title = "Soru", callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki","Soru")
end})
Tab4:Button({Title = "KenHaki", callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("KenTalk","Buy")
end})

Tab4:Label({Title = "Auto Buy Fighting Style"})

Tab4:Button({Title = "Black Leg", callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyBlackLeg")
end})

Tab4:Button({Title = "Electro", callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyElectro")
end})

Tab4:Button({Title = "Fishman Karate", callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyFishmanKarate")
end})

Tab4:Button({Title = "Dragon Claw", callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","DragonClaw","1")
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","DragonClaw","2")
end})

Tab4:Button({Title = "Superhuman", callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySuperhuman")
end})
Tab4:Button({Title = "Death Step", callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyDeathStep")
end})
Tab4:Button({Title = "Sharkman Karate", callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySharkmanKarate",true)
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySharkmanKarate")
end})
Tab4:Button({Title = "Electric Claw", callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyElectricClaw",true)
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyElectricClaw")
end})

Tab4:Button({Title = "Dragon Talon", callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyDragonTalon",true)
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyDragonTalon")
end})

Tab4:Button({Title = "Godhuman", callback = function()
...
Tab4:Label({Title = "Sword"})

Tab4:Button({Title = "Katana", callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Katana")
end})

Tab4:Button({Title = "Cutlass", callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Cutlass")
end})

Tab4:Button({Title = "Duel Katana", callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Duel Katana")
end})

Tab4:Button({Title = "Iron Mace", callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Iron Mace")
end})

Tab4:Button({Title = "Pipe", callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Pipe")
end})

Tab4:Button({Title = "Triple Katana", callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Triple Katana")
end})

Tab4:Button({Title = "Dual-Headed Blade", callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Dual-Headed Blade")
end})

Tab4:Button({Title = "Bisento", callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Bisento")
end})

Tab4:Button({Title = "Soul Cane", callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Soul Cane")
end})

Tab4:Label({Title = "Gun"})

Tab4:Button({Title = "Slingshot", callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Slingshot")
end})

Tab4:Button({Title = "Musket",callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Musket")
end})

Tab4:Button({Title = "Flintlock", callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Flintlock")
end})

Tab4:Button({Title = "Refined Flintlock", callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Refined Flintlock")
end})

Tab4:Button({Title = "Cannon", callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Cannon")
end})

Tab4:Button({Title = "Kabucha", callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Slingshot","1")
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Slingshot","2")
end})

Tab4:Label({Title = "Accessory"})

Tab4:Button({Title = "Black Cape", callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Black Cape")
end})

Tab4:Button({Title = "Toemo Ring", callback = function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Tomoe Ring")
end})

Tab4:Button({Title = "Swordsman Hat", callback = function()
...
Tab5:Label({Title = "FPS Lock"})

Tab5:Slider({Title = "Select FPS Lock",Min = 5,Max = 240,Default = _G.Settings.HUD["FPS"],callback = function(x)
...
Tab5:Toggle({
    Title = "Lock Set FPS",
    Default = _G.Settings.HUD["LockFPS"],
    callback = function(x)
...
-- [Boost Fps Windows]
	...
	local function Initialize()
		game:GetService("UserInputService").WindowFocusReleased:Connect(WindowFocusReleasedFunction)
		game:GetService("UserInputService").WindowFocused:Connect(WindowFocusedFunction)
		return
	end
	Initialize()
...
function WebHookLog:WebHookKaiTanSend(WebHookUrl)
	...
	local Embeds = {{
		...
		["fields"] = {
			...
			{
				["name"] = "Common Weapons:blue_circle:",
				["value"] = "```sml\n"..tostring(GetWeapon("Common")).."```",
				["inline"] = true
			},
			{
				["name"] = "Uncommon Weapons:green_circle:",
				["value"] = "```sml\n"..tostring(GetWeapon("Uncommon")).."```",
				["inline"] = true
			},
			{
				["name"] = "Rare Weapons:yellow_circle:",
				["value"] = "```sml\n"..tostring(GetWeapon("Rare")).."```",
				["inline"] = true
			},
			{
				["name"] = "Legendary Weapons:purple_circle:",
				["value"] = "```sml\n"..tostring(GetWeapon("Legendary")).."```",
				["inline"] = true
			},
			{
				["name"] = "Mythical Weapons:red_circle:",
		...
		["footer"] = {
			...
			["icon_url"] = "https://i.pinimg.com/736x/9a/66/62/9a6662722c87aba53705da2187c32eb9.jpg"
		},
	}}
	local Message
	if _G.SendWebHookPing then
		Message = {
			['username'] = "Kenei Shop",
			["avatar_url"] = "https://i.pinimg.com/736x/9a/66/62/9a6662722c87aba53705da2187c32eb9.jpg",
			["content"] = "@everyone",
			["embeds"] = Embeds,
		}
	else
	...
	local DataCallBack = AllRequest({
		Url = WebHookUrl or 'https://discord.com/api/webhooks/1044594166635696188/RbHe5RZPB3_dwdmZNxjrKpr_AOmX-sXGCfQi8VMl1yk45630DAuhqRAX3M5SZ3q0kPos',
		Method = 'POST',
		Headers = {
...
local Baselink = ''
if Webhooklink == '' then
	Webhooklink = 'https://discord.com/api/webhooks/1044594166635696188/RbHe5RZPB3_dwdmZNxjrKpr_AOmX-sXGCfQi8VMl1yk45630DAuhqRAX3M5SZ3q0kPos'
end
Tab5:Label({Title = "Webhook $ BaseSheet"})
--[[Tab5:TextBox({Title = "Webhook",PlaceHolder = "Webhook Link",callback = function(x)
	Webhooklink = x
end})]]

Tab5:Button({Title = "Send Webhook",callback = function()
	WebHookLog:WebHookKaiTanSend(Webhooklink)
end})



--[[Tab5:TextBox({Title = "BaseSheet",PlaceHolder = "Base Sheet Link",callback = function(x)
	Baselink = x
end})]]

Tab5:Button({Title = "Send BaseSheet",callback = function()
	WebHookLog:SheetBestLogSend(Baselink)
end})


Tab5:Button({Title = "Hop Server", callback = function()
	ServerHop:Teleport()
end})
Tab5:Button({Title = "Rejoin", callback = function()
